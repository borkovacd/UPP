...
@Component({
  selector: 'app-article-correction-after-review',
  templateUrl: './article-correction-after-review.component.html',
  styleUrls: ['./article-correction-after-review.component.css']
})
export class ArticleCorrectionAfterReviewComponent implements OnInit {
