...
@Component({
  selector: 'app-article-correction',
  templateUrl: './article-correction.component.html',
  styleUrls: ['./article-correction.component.css']
})
export class ArticleCorrectionComponent implements OnInit {
