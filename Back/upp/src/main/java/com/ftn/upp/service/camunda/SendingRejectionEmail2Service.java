...
@Service
public class SendingRejectionEmail2Service implements JavaDelegate{
	...
	public void sendNotificaitionAsync(String processInstanceId,
		...
		String htmlMsg = "<h4>Obavestavamo Vas da je rad koji ste prijavili odbijen od strane glavnog urednika tokom procesa recenziranja.</h4>";
