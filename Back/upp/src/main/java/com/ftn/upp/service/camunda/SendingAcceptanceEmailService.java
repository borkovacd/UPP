...
@Service
public class SendingAcceptanceEmailService implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		{
			System.out.println("Greska prilikom slanja emaila autoru za obavestenje o prihvatanju rada: " + e.getMessage());
		}
	...
	public void sendNotificaitionAsync(String processInstanceId,
		...
		String htmlMsg = "<h4>Obavestavamo Vas da je rad koji ste prijavili prihvacen!</h4>";
		mimeMessage.setContent(htmlMsg, "text/html");
		helper.setTo(email);
		helper.setSubject("Obaveštenje o prihvatanju rada");
